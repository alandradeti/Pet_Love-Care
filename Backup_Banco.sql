...
insert  into `tb_agendamento`(`Id_Agendamento`,`Tipo_Agendamento`,`Data_Agendamento`,`Horario_Agendamento`,`Vacina_Id_Vacina`,`Pet_Id_Pet`,`Cliente_Id_Cliente`,`Veterinario_Id_Veterinario`) values 
(5,'Consulta','2020-05-16','14:30:00',0,3,10,3);
