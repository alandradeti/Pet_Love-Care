...
insert  into `tb_veterinario`(`Id_Veterinario`,`Nome_Veterinario`,`Cpf_Veterinario`,`Rg_Veterinario`,`Sexo_Veterinario`,`Endereco_Veterinario`,`Email_Veterinario`,`Telefone_Fixo_Veterinario`,`Telefone_Celular_Veterinario`,`Data_Nascimento_Veterinario`,`Senha_Veterinario`) values 
(1,'dsfdsfsd','dsfdsfds','dsfsdfdsf','M','dsfdsfsds','dsfdsf@sdasdasd','6549832','asdasdsad','1999-12-15','asdadsas');
